...
public class BookcityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_bookcity, container, false);
        final TextView textView = root.findViewById(R.id.text_bookcity);
        bookcityViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
